...
pub fn add_a_u8(cpu: &mut CPU) {
    let value = cpu.mmu.fetch_u8(cpu.pc + 1);
    let (result, carry) = cpu.a.overflowing_add(value);
    let zero = result == 0;
    let half_carry = (cpu.a & 0xF) + (value & 0xF) > 0xF;
    cpu.update_flags(Some(zero), Some(carry), Some(false), Some(half_carry));
...
pub fn add_sp_i8(cpu: &mut CPU) {
    let offset = cpu.mmu.fetch_i8(cpu.pc + 1);
...
pub fn ld_b_u8(cpu: &mut CPU) {
    cpu.b = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_c_u8(cpu: &mut CPU) {
    cpu.c = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_d_u8(cpu: &mut CPU) {
    cpu.d = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_e_u8(cpu: &mut CPU) {
    cpu.e = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_h_u8(cpu: &mut CPU) {
    cpu.h = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_l_u8(cpu: &mut CPU) {
    cpu.l = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}

pub fn ld_a_u8(cpu: &mut CPU) {
    cpu.a = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.timer.add_cycles(8);
    cpu.pc += 2;
}
...
pub fn ld_bc_u16(cpu: &mut CPU) {
    cpu.c = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.b = cpu.mmu.fetch_u8(cpu.pc + 2);
    cpu.timer.add_cycles(12);
    cpu.pc += 3;
}
...
pub fn ld_de_u16(cpu: &mut CPU) {
    cpu.e = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.d = cpu.mmu.fetch_u8(cpu.pc + 2);
    cpu.timer.add_cycles(12);
    cpu.pc += 3;
}
...
pub fn ld_hl_u16(cpu: &mut CPU) {
    cpu.l = cpu.mmu.fetch_u8(cpu.pc + 1);
    cpu.h = cpu.mmu.fetch_u8(cpu.pc + 2);
    cpu.timer.add_cycles(12);
    cpu.pc += 3;
}

pub fn ld_sp_u16(cpu: &mut CPU) {
    cpu.sp = ((cpu.mmu.fetch_u8(cpu.pc + 2) as u16) << 8) | (cpu.mmu.fetch_u8(cpu.pc + 1) as u16);
    cpu.timer.add_cycles(12);
    cpu.pc += 3;
}
...
pub fn ld_a_m_r_u16(cpu: &mut CPU, register1: u8, register2: u8) {
    let address = ((register1 as u16) << 8) | (register2 as u16);
    cpu.a = cpu.mmu.read_byte(address);
    cpu.timer.add_cycles(8);
    cpu.pc += 1;
}
...
pub fn ld_m_hl_r_u8(cpu: &mut CPU, register: u8) {
    let address = ((cpu.h as u16) << 8) | (cpu.l as u16);
    cpu.mmu.write_byte(address, register);
    cpu.timer.add_cycles(8);
    cpu.pc += 1;
}
...
pub fn ld_m_u16_sp(cpu: &mut CPU) {
    let address = ((cpu.mmu.fetch_u8(cpu.pc + 2) as u16) << 8) | (cpu.mmu.fetch_u8(cpu.pc + 1) as u16);
    let lower_byte = (cpu.sp & 0xFF) as u8;
    let upper_byte = (cpu.sp >> 8) as u8;
    cpu.mmu.write_byte(address, lower_byte);
    cpu.mmu.write_byte(address + 1, upper_byte);
    cpu.timer.add_cycles(20);
    cpu.pc += 3;
}
...
pub fn ld_ff00_plus_u8_a(cpu: &mut CPU) {
    let value = cpu.mmu.fetch_u8(cpu.pc + 1) as u16;
...
pub fn jp_u16(cpu: &mut CPU) {
    cpu.timer.add_cycles(16);
    cpu.pc = ((cpu.mmu.fetch_u8(cpu.pc + 2) as u16) << 8) | (cpu.mmu.fetch_u8(cpu.pc + 1) as u16);
}
...
pub fn pop_bc(cpu: &mut CPU) {
    cpu.b = cpu.mmu.fetch_u8(cpu.sp + 1);
    cpu.c = cpu.mmu.fetch_u8(cpu.sp);
    cpu.sp += 2;
    cpu.timer.add_cycles(12);
    cpu.pc += 1;
}
...
pub fn pop_de(cpu: &mut CPU) {
    cpu.d = cpu.mmu.fetch_u8(cpu.sp + 1);
    cpu.e = cpu.mmu.fetch_u8(cpu.sp);
    cpu.sp += 2;
    cpu.timer.add_cycles(12);
    cpu.pc += 1;
}
...
pub fn pop_hl(cpu: &mut CPU) {
    cpu.h = cpu.mmu.fetch_u8(cpu.sp + 1);
    cpu.l = cpu.mmu.fetch_u8(cpu.sp);
    cpu.sp += 2;
    cpu.timer.add_cycles(12);
    cpu.pc += 1;
}
...
pub fn pop_af(cpu: &mut CPU) {
    cpu.a = cpu.mmu.fetch_u8(cpu.sp + 1);
    let f = cpu.mmu.fetch_u8(cpu.sp);
    cpu.update_flags(
        Some(f & 0x80 != 0),
        Some(f & 0x10 != 0),
        Some(f & 0x40 != 0),
...
pub fn push_bc(cpu: &mut CPU) {
    cpu.sp -= 2;
    cpu.mmu.write_byte(cpu.sp + 1, cpu.b);
    cpu.mmu.write_byte(cpu.sp, cpu.c);
    cpu.timer.add_cycles(16);
    cpu.pc += 1;
}
...
pub fn push_de(cpu: &mut CPU) {
    cpu.sp -= 2;
    cpu.mmu.write_byte(cpu.sp + 1, cpu.d);
    cpu.mmu.write_byte(cpu.sp, cpu.e);
    cpu.timer.add_cycles(16);
    cpu.pc += 1;
}
...
pub fn push_hl(cpu: &mut CPU) {
    cpu.sp -= 2;
    cpu.mmu.write_byte(cpu.sp + 1, cpu.h);
    cpu.mmu.write_byte(cpu.sp, cpu.l);
    cpu.timer.add_cycles(16);
    cpu.pc += 1;
}
...
pub fn push_af(cpu: &mut CPU) {
    cpu.sp -= 2;
    cpu.mmu.write_byte(cpu.sp + 1, cpu.a);
    cpu.mmu.write_byte(cpu.sp, cpu.f);
    cpu.timer.add_cycles(16);
    cpu.pc += 1;
}
...
pub fn call_u16(cpu: &mut CPU) {
    ...
    cpu.sp -= 2;
    cpu.mmu.write_byte(cpu.sp + 1, upper_byte);
    cpu.mmu.write_byte(cpu.sp, lower_byte);
    cpu.timer.add_cycles(24);
    cpu.pc = ((cpu.mmu.fetch_u8(cpu.pc + 2) as u16) << 8) | (cpu.mmu.fetch_u8(cpu.pc + 1) as u16);
}
...
pub fn ret(cpu: &mut CPU) {
    cpu.timer.add_cycles(16);
    cpu.pc = ((cpu.mmu.fetch_u8(cpu.sp + 1) as u16) << 8) | (cpu.mmu.fetch_u8(cpu.sp) as u16); 
    cpu.sp += 2;
}
